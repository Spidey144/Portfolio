    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a href="#" className="text-white/70 text-3xl font-black tracking-tight hover:text-white/100 hover:scale-105 transition">
            Sangareshwaran<span className="text-red-500">.</span>
          </a>
        </div>
